...
namespace TestWindowsApplication
{
    public partial class Delta : Form
    {
        ...
        PivotCPRBasics pivotCPRBasics;//= new PivotCPRBasics();
        StrangleShiftToOneSide strangleShiftToOneSide;//= new StrangleShiftToOneSide();
        ManageStrangleWithMaxPain manageStrangleWithMaxPain;// = new ManageStrangleWithMaxPain();
        ...
        private void BtnOrder_Click(object sender, EventArgs e)
        {
            ...
            //Dec Expiry - NF
            peToken.LastPrice = 83; 
            ceToken.LastPrice = 71; 
            bInst.LastPrice = 12147;

            //Dec Expiry - BNF
            peToken.LastPrice = 573;//BANKNIFTY19DEC32000PE - 9603330
            ceToken.LastPrice = 573; //BANKNIFTY19DEC32000CE - 9603074
            bInst.LastPrice = 32008;

            //12 Dec expiry
            //peToken.LastPrice = 40; //11900 PE
            //ceToken.LastPrice = 32; //12300 CE
            //peToken.LastPrice = 70; //12000 PE
            //ceToken.LastPrice = 60; //12200 CE

            bInst.LastPrice = 12147;

            //bInst.InstrumentToken = 12517890; //NIFTY DEC FUTURE
            //bInst.InstrumentToken = 12516098; //BNF NIFTY DEC FUTURE
            ...
            else if (tbctrlDeltaValue.SelectedIndex == 4)
            {
                ...
                manageStrangleConstantWidth.ManageStrangleWithConstantWidth(bInst, peToken, ceToken,
                    Convert.ToDecimal(txtMaxLossPoints.Text), timeOfOrder:Convert.ToDateTime("2019-12-01 09:15:00"));
            ...
            else if (tbctrlDeltaValue.SelectedIndex == 5)
            {
                ...
                //    Convert.ToInt32(txtMaxQty.Text), Convert.ToInt32(txtStepQty.Text), timeOfOrder: Convert.ToDateTime("2019-12-02 09:15:00"));

                

                strangleShiftToOneSide.StoreStrangleShiftToOneSideTrade(bInst, peToken, ceToken, Convert.ToInt32(txtInitialQty.Text),
                   Convert.ToInt32(txtMaxQty.Text), Convert.ToInt32(txtStepQty.Text), timeOfOrder: Convert.ToDateTime("2019-12-02 09:15:00"));
            ...
            else if (tbctrlDeltaValue.SelectedIndex == 7)
            {
                ...
                expiryTrade.StoreIndexForExpiryTrade(bInst.InstrumentToken, Convert.ToDateTime(lstBxExpiry.SelectedItem.ToString()), Convert.ToInt32(txtTradingQty.Text),
                  Convert.ToInt32(strikePriceIncrement), Convert.ToDecimal(txtMaxLoss.Text), Convert.ToDecimal(txtProfitTarget.Text), timeOfOrder: Convert.ToDateTime("2019-09-25 09:23:00"));
        ...
        private void Delta_Load(object sender, EventArgs e)
        {
            ...
            DateTime expiry = Convert.ToDateTime("2019-04-25");
            //Retrive all options
        ...
        private void BtnDummy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //pivotCPRBasics.Subscribe(dataStreamer);
                ...
                //activeBuyStrangleManagerWithVariableQty.Subscribe(dataStreamer);
                //strangleShiftToOneSide.Subscribe(dataStreamer);
                //manageStrangleWithMaxPain.Subscribe(dataStreamer);
               // expiryTrade.Subscribe(dataStreamer);
