...
namespace TradeEMACross.Controllers
{
    ...
    public class ChartController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task <ActiveAlgosView> Draw([FromBody] ChartDataInputs chartDataInput, int algoInstance = 0)
        {
            ...
            StrangleChart strangleChart =
                new StrangleChart(instrumentToken, expiry1, expiry2, chartDataInput.S1, chartDataInput.S2, 
                chartDataInput.CMB, chartDataInput.IVC, chartDataInput.OIC, chartDataInput.IT1, chartDataInput.IT2, 
            ...
            {
                aid = Convert.ToInt32(AlgoIndex.ChartSpreadTrade),
                an = Convert.ToString((AlgoIndex)AlgoIndex.ChartSpreadTrade),
                ains = algoInstance,
