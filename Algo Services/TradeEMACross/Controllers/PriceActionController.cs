...
namespace TradeEMACross.Controllers
{
    ...
    [ApiController]
    public class PriceActionController : ControllerBase
    {
        ...
        {
            PAWithLevels paTrader =  await ExecuteAlgo(paInputs);
//#if local
//            DataLogic dl = new DataLogic();
//            DataSet dsPAInputs = dl.LoadAlgoInputs(AlgoIndex.PAWithLevels, Convert.ToDateTime("2021-12-01"), Convert.ToDateTime("2021-12-30"));
...
//#endif
            ...
            List<PAWithLevels> activeAlgoObjects = _cache.Get<List<PAWithLevels>>(key);
            ...
            {
                aid = Convert.ToInt32(AlgoIndex.PAWithLevels),
                an = Convert.ToString((AlgoIndex)AlgoIndex.PAWithLevels),
        ...
        private async Task<PAWithLevels> ExecuteAlgo(PriceActionInput paInputs)
        {
