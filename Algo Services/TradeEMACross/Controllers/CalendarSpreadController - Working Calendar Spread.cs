...
namespace TradeEMACross.Controllers
{
    ...
    {
        private const string okey = "ACTIVE_CALTrade_OPTIONS";

        IConfiguration configuration;
        ZMQClient zmqClient;
        private IMemoryCache _cache;
        public CalendarSpreadController(IMemoryCache cache)
        {
            this._cache = cache;
        }
        ...
        public async Task<ActiveAlgosView> Trade([FromBody] OptionIVSpreadInput optionIVSpreadInput, int algoInstance = 0)
        {
            ...
            int maxQty = 8;
            int stepQty = 4;
            optionIVSpreadInput.OpenSpread = 10;
            optionIVSpreadInput.CloseSpread = 10;
#if local
            ...
            CalendarSpreadValueScalping calendarSpreadIVScalper =
                new CalendarSpreadValueScalping(endDateTime, instrumentToken, expiry1, expiry2,
                optionQuantity, maxQty, stepQty, targetProfit: optionIVSpreadInput.TP, openSpread: optionIVSpreadInput.OpenSpread, 
                closeSpread: optionIVSpreadInput.CloseSpread, stopLoss: 0, // optionIVSpreadInput.SL,
            ...
            List<CalendarSpreadValueScalping> activeAlgoObjects = _cache.Get<List<CalendarSpreadValueScalping>>(okey);
