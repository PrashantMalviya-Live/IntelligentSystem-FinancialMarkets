...
namespace LocalDBData.Test
{
    public class BCTest : ITest
    {
        ...
        private BreakoutCandles ExecuteAlgo(PriceActionInput paInputs)
        {
            BreakoutCandles paTrader =
                new BreakoutCandles(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Expiry,
                paInputs.Qty, paInputs.UID, paInputs.TP, paInputs.SL,
        ...
        private void ObserverSubscription(BreakoutCandles paTrader)
        {
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.BreakoutCandles);
        //        }
