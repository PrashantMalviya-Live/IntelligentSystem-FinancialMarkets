...
{
    public class RangeBreakoutCandleTest : ITest
    {
        ...
        private RangeBreakoutCandle ExecuteAlgo(PriceActionInput paInputs)
        {
            RangeBreakoutCandle paTrader =
                new RangeBreakoutCandle(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Expiry,
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.RangeBreakoutCandle);
        //        }
