...
{
    internal class StockTrendTest : ITest
    {
        StockTrend paTrader;
        ...
        private StockTrend ExecuteAlgo(PriceActionInput paInputs)
        {
            StockTrend paTrader =
              new StockTrend(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Expiry,
        ...
        private void ObserverSubscription(StockTrend paTrader)
        {
