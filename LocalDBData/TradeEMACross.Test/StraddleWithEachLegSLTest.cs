...
{
    internal class StraddleWithEachLegSLTest : ITest
    {
        StraddleWithEachSideSL paTrader;
        ...
        private StraddleWithEachSideSL ExecuteAlgo(StraddleInput paInputs)
        {
            StraddleWithEachSideSL paTrader =
                new StraddleWithEachSideSL(paInputs.BToken, paInputs.Qty, expiryDate: paInputs.Expiry, uid: paInputs.UID, httpClientFactory: null);
        ...
        private void ObserverSubscription(StraddleWithEachSideSL paTrader)
        {
