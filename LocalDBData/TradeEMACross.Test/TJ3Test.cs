...
namespace LocalDBData.Test
{
    internal class TJ3Test : ITest
    {
        ...
        private TJ2 ExecuteAlgo(PriceActionInput paInputs)
        {
            ...
            //TJ3 paTrader =
            //    new TJ3(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.RToken, paInputs.Expiry,
            //    paInputs.Qty, paInputs.UID, paInputs.TP, paInputs.SL, paInputs.IntD, //pdOHLC, pwOHLC,
        ...
        private void ObserverSubscription(TJ2 paTrader)
        {
            //GlobalObjects.ObservableFactory ??= new ObservableFactory();
            //paTrader.Subscribe(GlobalObjects.ObservableFactory);
        }

        //private async Task NMQClientSubscription(TJ3 paTrader, uint token)
        //{
        ...
        //}
#if local
        private async Task KFKClientSubscription(TJ3 paTrader, uint token)
        {
        ...
        //private async Task ObserverSubscription(TJ3 paTrader, uint token)
        //{
        //    GlobalObjects.ObservableFactory ??= new ObservableFactory();
        //    paTrader.Subscribe(GlobalObjects.ObservableFactory);
        //}
        //private async Task MQTTCientSubscription(TJ3 paTrader, uint token)
        //{
        ...
        //}
#endif
        //        private void PATrade_OnOptionUniverseChange(TJ3 source)
        //        {
        //            try
        //            {
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.TJ3);
        //        }

        //        [HttpPut("{ain}")]
        //        public bool Put(int ain, [FromBody] int start)
        //        {
        //            List<TJ3> activeAlgoObjects;
        //            if (!_cache.TryGetValue(key, out activeAlgoObjects))
        //            {
        //                activeAlgoObjects = new List<TJ3>();
        //            }

        //            TJ3 algoObject = activeAlgoObjects.FirstOrDefault(x => x.AlgoInstance == ain);
        //            if (algoObject != null)
        //            {
