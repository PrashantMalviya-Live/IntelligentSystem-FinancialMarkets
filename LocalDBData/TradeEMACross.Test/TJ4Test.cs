...
namespace LocalDBData.Test
{
    internal class TJ4Test : ITest
    {
        ...
        private TJ4 ExecuteAlgo(PriceActionInput paInputs)
        {
            TJ4 paTrader =
                new TJ4(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.RToken.Value, paInputs.Expiry,
        ...
        private void ObserverSubscription(TJ4 paTrader)
        {
