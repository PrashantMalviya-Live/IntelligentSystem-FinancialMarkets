...
{
    internal class MultipleEMAPriceActionTest : ITest
    {
        MultipleEMAPriceAction paTrader;
        ...
        private MultipleEMAPriceAction ExecuteAlgo(PriceActionInput paInputs)
        {
            MultipleEMAPriceAction paTrader =
                new MultipleEMAPriceAction(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Qty, paInputs.UID, httpClientFactory: null);
        ...
        private void ObserverSubscription(MultipleEMAPriceAction paTrader)
        {
            //GlobalObjects.ObservableFactory ??= new ObservableFactory();
            //paTrader.Subscribe(GlobalObjects.ObservableFactory);
        }

        //private async Task NMQClientSubscription(MultipleEMAPriceAction paTrader, uint token)
        //{
        ...
        //}
#if local
        private async Task KFKClientSubscription(MultipleEMAPriceAction paTrader, uint token)
        {
        ...
        //private async Task ObserverSubscription(MultipleEMAPriceAction paTrader, uint token)
        //{
        //    GlobalObjects.ObservableFactory ??= new ObservableFactory();
        //    paTrader.Subscribe(GlobalObjects.ObservableFactory);
        //}
        //private async Task MQTTCientSubscription(MultipleEMAPriceAction paTrader, uint token)
        //{
        ...
        //}
#endif
        //        private void PATrade_OnOptionUniverseChange(MultipleEMAPriceAction source)
        //        {
        //            try
        //            {
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.MultipleEMAPriceAction);
        //        }

        //        [HttpPut("{ain}")]
        //        public bool Put(int ain, [FromBody] int start)
        //        {
        //            List<MultipleEMAPriceAction> activeAlgoObjects;
        //            if (!_cache.TryGetValue(key, out activeAlgoObjects))
        //            {
        //                activeAlgoObjects = new List<MultipleEMAPriceAction>();
        //            }

        //            MultipleEMAPriceAction algoObject = activeAlgoObjects.FirstOrDefault(x => x.AlgoInstance == ain);
        //            if (algoObject != null)
        //            {
