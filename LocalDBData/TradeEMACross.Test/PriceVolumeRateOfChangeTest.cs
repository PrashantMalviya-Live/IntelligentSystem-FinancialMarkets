...
{
    internal class PriceVolumeRateOfChangeTest : ITest
    {
        PriceVolumeRateOfChange paTrader;
        ...
        private PriceVolumeRateOfChange ExecuteAlgo(PriceActionInput paInputs)
        {
            PriceVolumeRateOfChange paTrader =
                new PriceVolumeRateOfChange(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, 
                paInputs.Expiry, paInputs.Qty, paInputs.UID, paInputs.TP, paInputs.SL, 5, 13, 
        ...
        private void ObserverSubscription(PriceVolumeRateOfChange paTrader)
        {
