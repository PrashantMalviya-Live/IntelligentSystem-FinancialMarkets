...
{
    internal class MultiTimeFrameSellOnHTTest : ITest
    {
        ...
        private MultiTimeFramSellOnHT ExecuteAlgo(PriceActionInput paInputs)
        {
            MultiTimeFramSellOnHT paTrader =
                new MultiTimeFramSellOnHT(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Expiry,
                paInputs.Qty, paInputs.UID, paInputs.TP, paInputs.SL, //pdOHLC, pwOHLC,
        ...
        private void ObserverSubscription(MultiTimeFramSellOnHT paTrader)
        {
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.MultiTimeFramSellOnHT);
        //        }
