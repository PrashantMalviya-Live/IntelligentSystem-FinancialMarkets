...
{
    public class StraddleExpiryTradeTest : ITest
    {
        ...
        private StraddleExpiryTrade ExecuteAlgo(StraddleInput paInputs)
        {
            StraddleExpiryTrade paTrader =
                new StraddleExpiryTrade(new TimeSpan(0, paInputs.CTF,0), paInputs.BToken, paInputs.Expiry, paInputs.Qty, 
                paInputs.UID, paInputs.TP, paInputs.SL, true, paInputs.SPI, paInputs.Flag, paInputs.TR,
        ...
        private void ObserverSubscription(StraddleExpiryTrade paTrader)
        {
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.StraddleExpiryTrade);
        //        }
