...
{
    internal class OptionBuyOnEMACrossTimeVolumeTest : ITest
    {
        OptionBuyonEMACross paTrader;

        public void Execute(OptionBuyOnEMACrossInputs paInputs)
        {
        ...
        private OptionBuyonEMACross ExecuteAlgo(OptionBuyOnEMACrossInputs paInputs)
        {
            OptionBuyonEMACross paTrader =
                new OptionBuyonEMACross(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Qty, paInputs.UID, targetProfit:50, stopLoss:10, sEMALength:10, lEMALength:20, httpClientFactory: null);// firebaseMessaging);
        ...
        private void ObserverSubscription(OptionBuyonEMACross paTrader)
        {
