...
{
    public class CryptoRBCTest : ICryptoTest
    {
        CryptoRBC paTrader;
        ...
        private void ObserverSubscription(CryptoRBC paTrader)
        {
            //GlobalObjects.ObservableFactory ??= new ObservableFactory();
            //paTrader.Subscribe(GlobalObjects.ObservableFactory);
        }

        //private async Task NMQClientSubscription(CryptoRBC paTrader, uint token)
        //{
        ...
        //}
#if local
        private async Task KFKClientSubscription(CryptoRBC paTrader, uint token)
        {
        ...
        //private async Task ObserverSubscription(CryptoRBC paTrader, uint token)
        //{
        //    GlobalObjects.ObservableFactory ??= new ObservableFactory();
        //    paTrader.Subscribe(GlobalObjects.ObservableFactory);
        //}
        //private async Task MQTTCientSubscription(CryptoRBC paTrader, uint token)
        //{
        ...
        //}
#endif
        //        private void PATrade_OnOptionUniverseChange(CryptoRBC source)
        //        {
        //            try
        //            {
        ...
        //        {
        //            return Task.FromResult((int)AlgoIndex.CryptoRBC);
        //        }

        //        [HttpPut("{ain}")]
        //        public bool Put(int ain, [FromBody] int start)
        //        {
        //            List<CryptoRBC> activeAlgoObjects;
        //            if (!_cache.TryGetValue(key, out activeAlgoObjects))
        //            {
        //                activeAlgoObjects = new List<CryptoRBC>();
        //            }

        //            CryptoRBC algoObject = activeAlgoObjects.FirstOrDefault(x => x.AlgoInstance == ain);
        //            if (algoObject != null)
        //            {
