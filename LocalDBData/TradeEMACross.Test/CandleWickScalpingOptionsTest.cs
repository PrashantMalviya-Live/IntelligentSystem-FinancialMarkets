...
{
    internal class CandleWickScalpingOptionsTest : ITest
    {
        ...
        {
            CandleWickScalpingOptions paTrader =
                new CandleWickScalpingOptions(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Qty, paInputs.UID, httpClientFactory: null);// firebaseMessaging);
        ...
        private void ObserverSubscription(CandleWickScalpingOptions paTrader)
        {
