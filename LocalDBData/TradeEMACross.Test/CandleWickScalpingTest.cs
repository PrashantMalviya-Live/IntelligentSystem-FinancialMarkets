...
{
    internal class CandleWickScalpingTest : ITest
    {
        CandleWickScalping paTrader;
        ...
        private CandleWickScalping ExecuteAlgo(PriceActionInput paInputs)
        {
            CandleWickScalping paTrader =
                new CandleWickScalping(TimeSpan.FromMinutes(paInputs.CTF), paInputs.BToken, paInputs.Expiry, paInputs.Qty, paInputs.TP, paInputs.SL, //pdOHLC, pwOHLC,
        ...
        private void ObserverSubscription(CandleWickScalping paTrader)
        {
