...
namespace KotakConnect
{
    ...
    public class Kotak
    {
        ...
        private string _root = "https://tradeapi.kotaksecurities.com/apim";
        ...
        private string _consumerKey = "tpayXGqA2my6N8OXRdWYo1ynvoka"; // sandbox: "UqtkUfmbeLi3UPdnMS6rvfKlhB4a"; // production: "tpayXGqA2my6N8OXRdWYo1ynvoka";
        private string _accessToken = "dead6a06-113e-3ef6-bb46-897401304140";// Production: "bf4e6cd5-a29b-339c-b6be-bca6626bbcf5";
        private string _secret = "HLMr5U4TPvrEVRWK1zHfRDeDj68a";
        ...
        private readonly Dictionary<string, string> _routes = new Dictionary<string, string>
        {
            ...
            ["orders.modify"] = "/orders/1.0/order/{product}/{orderId}",
        ...
        public Kotak(string APIKey, string AccessToken, string SessonToken = null, string Root = null, 
        ...
        {
            string accessCode = GenerateOTT(userid, password);
            _sessionToken = GenerateSession(userid, accessCode);
        ...
        public string GenerateOTT(string userId, string password)
        {
            ...
            var accessCode = Post("session.ott", param);
        ...
        /// <param name="AppSecret">API secret issued with the API key.</param>
        /// <returns>User structure with tokens and profile data</returns>
        public string GenerateSession(string userId, string accessCode)
        {
            var param = new Dictionary<string, dynamic>
            {
                {"userid", userId}
            ...
            _ott = accessCode;
            var userData = Post("session.token", param);
            ...
            string Tag = "")
        {
            ...
            //Utils.AddIfNotNull(param, "price", TransactionType.ToLower() == "sell" ? Price - 10 : Price + 10);
        ...
        public KotakOrder GetOrderHistory(string OrderId)
        {
            //var param = new Dictionary<string, dynamic>();
            //param.Add("orderId", OrderId);

            var orderData = Get("reports.orderhistory"); //, param);
        ...
        private dynamic Request(string Route, string Method, Dictionary<string, dynamic> Params = null)
        {
            ...
            if (Method == "POST" || Method == "PUT")
            {
                ...
                httpRequest.Headers["consumerKey"] = _consumerKey;
                ...
                {
                    httpRequest.Headers["oneTimeToken"] = _ott;
                }
                if (Route == "orders.place")
                {
                    httpRequest.Headers["sessionToken"] = _sessionToken;
                }
                else
                {
                    httpRequest.Headers["ip"] = _ipAddress;
                    httpRequest.Headers["appId"] = _appId;
                }
