...
namespace Algorithms.Candles
{
	public class CandlesSeriesHolder
	{
		...
		{
			private readonly Dictionary<long, CandlesSeriesHolder> _holders = new Dictionary<long, CandlesSeriesHolder>();

			/// <summary>
			/// List of all candles series, subscribed via <see cref="CreateCandleSeries"/>.
			/// </summary>
			//public IEnumerable<CandleSeries> AllCandleSeries => _holders.Select(h => h.Series);
