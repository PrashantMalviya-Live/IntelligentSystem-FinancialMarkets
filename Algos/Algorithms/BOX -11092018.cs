...
namespace AdvanceAlgos.Algorithms
{
    class BOX
    {
        ...
        private static void BoxSpread()
        {
            ...
            foreach (decimal vstrike in strikePrices)
            {
                ...
                foreach (decimal hstrike in strikePrices)
                {
                    if (hstrike < vstrike)
                    {
                        ...
                        {
                            tempBoxValue = sellOption;
                        }
                        else
                        {
                            tempBoxValue = buyOption;
                            Logger.LogWrite(string.Format("HURRAY B:{0} | S:{1}", buyOption, -sellOption));
                        }
            ...
            if (boxValue > 750m && firstCallOption.Offers[1].Price * firstPutOption.Bids[1].Price * secondPutOption.Bids[1].Price * secondCallOption.Offers[1].Price != 0)
            {
