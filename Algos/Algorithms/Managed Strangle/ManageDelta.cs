...
namespace Algorithms.Algorithms
{
    public class ManageDelta : IZMQ
    {
        ...
        public ManageDelta(TimeSpan candleTimeSpan, uint baseInstrumentToken, DateTime? expiry, 
            int quantity, decimal deltaUpperLimit, decimal deltaLowerLimit, decimal deltaInitial,
