...
namespace AdvanceAlgos.Algorithms
{
    ...
    { 
        ...
        private void ReviewStrangle(InstrumentLinkedList optionList, Tick[] ticks)
        {
            ...
            InstrumentListNode subsequentNode = CheckForBuyBack(optionNode, SafetyBand);
        ...
        public async virtual void OnNext(Tick[] ticks)
        {
            ...
            {
                await ReviewStrangle(keyValuePair.Value[0], ticks);
                await ReviewStrangle(keyValuePair.Value[1], ticks);
                //await ReviewStrangle(ActiveStrangles[i][1], ticks);
            }
        }
        ...
        public void ManageStrangleBB(Instrument bInst, Instrument currentPE, Instrument currentCE,
            ...
            decimal ceMaxLossPoints = 0, decimal stopLossPoints = 0,
            ...
            if (currentPE.LastPrice * currentCE.LastPrice != 0)
            {
                ...
                if (strangleId == 0)
                {
                    ...
                    strangleId = dl.StoreStrangleData(currentCE.InstrumentToken, currentPE.InstrumentToken, call.Prices.Last(),
                       put.Prices.Last(), AlgoIndex.BBStrangle, ceMaxProfitPoints, ceMaxLossPoints, peMaxProfitPoints, peMaxLossPoints,
