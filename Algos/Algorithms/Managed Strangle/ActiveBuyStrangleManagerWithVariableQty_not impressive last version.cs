            ...
            try
            {
                ...
                lock (tradeLock)
                {
                    ...
                    if (_activeStrangle.CurrentPosition == PositionStatus.Open)
                    {
                        ...
                        if (pnl > _activeStrangle.InitialQty * multiplier * 10 || pnl < -10000)
                        ...
                        else if (pnl < _activeStrangle.InitialQty * multiplier * -20 && multiplier <5)
                        {
                            if (callOption.LastPrice > putOption.LastPrice)
                            {
                                int qty = Convert.ToInt32(Math.Round((callOption.LastPrice * _activeStrangle.InitialQty) / putOption.LastPrice / 25, 0) * 25);
                        ...
                        else if (multiplier > 1 && pnl > _activeStrangle.InitialQty * -20 * (multiplier - 2))
                        {
                            multiplier--;
                        ...
                        else
                        {
                            ...
                            if (Math.Abs(PutBuyCallSellQty) >= _activeStrangle.StepQty) //need more puts or less calls
                            {
                                ...
                                {
                                    if (_activeStrangle.CallTradedQty > _activeStrangle.InitialQty * multiplier)
                                    {
                                        callLegTradeCounter--;
                            ...
                            if (Math.Abs(PutSellCallBuyQty) >= _activeStrangle.StepQty) //need more calls or less puts
                            {
                                ...
                                {
                                    if (_activeStrangle.PutTradedQty > _activeStrangle.InitialQty * multiplier)
                                    {
                                        putLegTradeCounter--;
