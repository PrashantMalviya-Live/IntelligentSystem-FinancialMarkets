                            ...
                            if (_baseInstrumentPrice - _referenceStrike > 50)
                            {
                                ...
                                if (_activeStrangle.CallOrders.Count > 1 && _activeStrangle.CallOrders.Last().AveragePrice + 10*cc < _activeStrangle.Call.LastPrice)
                                {
                                    ...
                                    Order corder = MarketOrders.PlaceOrder(_algoInstance, callOption.TradingSymbol, "ce", _activeStrangle.Call.LastPrice,
                                       ...
                                       broker: Constants.ZERODHA, httpClient: _httpClientFactory == null ? null : _httpClientFactory.CreateClient());
                                ...
                                //porder = MarketOrders.PlaceOrder(_algoInstance, putOption.TradingSymbol, "pe", _activeStrangle.Put.LastPrice,
                                ...
                                //Order corder = MarketOrders.PlaceOrder(_algoInstance, callOption.TradingSymbol, "pe", _activeStrangle.Call.LastPrice,
                                ...
                                //corder = MarketOrders.PlaceOrder(_algoInstance, callOption.TradingSymbol, "pe", _activeStrangle.Call.LastPrice,
