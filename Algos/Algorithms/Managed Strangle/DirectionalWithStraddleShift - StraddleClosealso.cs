                        ...
                        if (currentValue > _referenceStraddleValue)
                        {
                            if (!_buyMode)
                            {
                                ...
                                if (callPriceDelta >= putPriceDelta)
                                {
                                    ...
                                    //{
                                    //    _callOrderTrio = TradeEntry(_referenceActiveCall, e.CloseTime, _referenceActiveCall.LastPrice, 2 * _tradeQty, true);
                                    //}
                                    //if (_putOrderTrio != null)
                                    //{
                                    ...
                                    //    else
                                    //    {
                                    //        TradeEntry(_referenceActivePut, e.CloseTime, _referenceActivePut.LastPrice, _tradeQty, true);
                                    //    }
                                    //    _putOrderTrio = null;
                                    //}
                                }
                                else
                                {
                                    ...
                                    //{
                                    //    _putOrderTrio = TradeEntry(_referenceActivePut, e.CloseTime, _referenceActivePut.LastPrice, 2 * _tradeQty, true);
                                    //}
                                    //if (_callOrderTrio != null)
                                    //{
                                    ...
                                    //    else
                                    //    {
                                    //        TradeEntry(_referenceActiveCall, e.CloseTime, _referenceActiveCall.LastPrice, _tradeQty, true);
                                    //    }
                                    //    _callOrderTrio = null;
                                    //}
                                }
