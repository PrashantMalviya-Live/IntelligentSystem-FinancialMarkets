...
{
    class InstantBOX : IObserver<Tick[]>
    {
        ...
        decimal baseInstrumentToken = 260105;

        static decimal currentBoxValue;
        
        static decimal currentPrice = 27300;
        ...
        private static void BoxSpreadDynamic(Tick[] ticks)
        {
            ...
            Tick baseInstrumentTick = ticks.FirstOrDefault(x => x.InstrumentToken == baseInstrumentToken);
            if (baseInstrumentTick.LastPrice != 0)
            {
                baseInstrumentPrice = baseInstrumentTick.LastPrice;
            }
            ...
            foreach (decimal vstrike in strikePrices)
            {
                ...
                foreach (decimal hstrike in strikePrices)
                {
                    if (hstrike < vstrike)
                    {
                        ...
                        decimal buyOption = (-callOption1.Offers[1].Price + putOption1.Bids[1].Price + callOption2.Bids[1].Price - putOption2.Offers[1].Price);
                        decimal sellOption = (callOption1.Bids[1].Price - putOption1.Offers[1].Price - callOption2.Offers[1].Price + putOption2.Bids[1].Price);


                        tempBoxValue = sellOption + buyOption;
            ...
            decimal[] avgPrice = new decimal[8];
            List<Order>[] orderInfos = new List<Order>[8];
            int count = 0;
            Dictionary<string, dynamic>[] orderStatus = new Dictionary<string, dynamic>[8];
            //Place Orders if good price
            if (boxValue > 3800m)// && !OrderPlaced )//&& firstCallOption.Offers[1].Price * firstPutOption.Bids[1].Price * secondPutOption.Bids[1].Price * secondCallOption.Offers[1].Price != 0 )
            {
                OrderPlaced = true;
                ...
                //orderStatus[0] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 40, firstCallOption.Offers[1].Price + 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                //orderStatus[1] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 40, secondCallOption.Bids[1].Price - 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                //orderStatus[2] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 40, secondPutOption.Offers[1].Price + 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                //orderStatus[3] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 40, firstPutOption.Bids[1].Price - 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");


                /////// GET QUOTE HERE BEFORE PLACING THE ORDER SO THAT YOU CAN SEE THAT THESE ORDERS ARE NOT AT VERY WRONG PRICE.PUT A BRACKET OF 5.
                //orderStatus[4] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 40, firstCallOption.Bids[1].Price - 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                //orderStatus[5] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 40, secondCallOption.Offers[1].Price + 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                //orderStatus[6] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 40, secondPutOption.Bids[1].Price - 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                //orderStatus[7] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 40, firstPutOption.Offers[1].Price + 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                ...
                avgPrice[0] = firstCallOption.Offers[1].Price + 0.1m;
                avgPrice[1] = secondCallOption.Bids[1].Price - 0.1m;
                avgPrice[2] = secondPutOption.Offers[1].Price + 0.1m;
                avgPrice[3] = firstPutOption.Bids[1].Price - 0.1m;

                avgPrice[4] = firstCallOption.Bids[1].Price - 0.1m;
                avgPrice[5] = secondCallOption.Offers[1].Price + 0.1m;
                avgPrice[6] = secondPutOption.Bids[1].Price - 0.1m;
                avgPrice[7] = firstPutOption.Offers[1].Price + 0.1m;

                boxValue = -avgPrice[0] + avgPrice[1] - avgPrice[2] + avgPrice[3] + avgPrice[4] - avgPrice[5] + avgPrice[6] - avgPrice[7];

                //orderIDs[0] = firstCallOrder["data"]["order_id"];
                //orderIDs[1] = secondCallOrder["data"]["order_id"];
                //orderIDs[2] = secondPutOrder["data"]["order_id"];
                //orderIDs[3] = firstPutOrder["data"]["order_id"];

                //avgPrice[0] = Global.kite.GetOrderHistory(firstCallOrder["data"]["order_id"]).AveragePrice;
                //avgPrice[1] = Global.kite.GetOrderHistory(secondCallOrder["data"]["order_id"]).AveragePrice;
                //avgPrice[2] = Global.kite.GetOrderHistory(secondPutOrder["data"]["order_id"]).AveragePrice;
                //avgPrice[3] = Global.kite.GetOrderHistory(firstPutOrder["data"]["order_id"]).AveragePrice;

                // OrderedBox = new Dictionary<string, BoxStatus> ();

                //// Two keys: Status & Data, order_id
                //OrderedBox.Add(orderIDs[0], new BoxStatus(firstCallOption.InstrumentToken, avgPrice[0], 40));
                ////OrderedBox.Add(orderIDs[1], new BoxStatus(secondCallOption.InstrumentToken, avgPrice[1], 40));
                ////OrderedBox.Add(orderIDs[2], new BoxStatus(secondPutOption.InstrumentToken, avgPrice[2], 40));
                ////OrderedBox.Add(orderIDs[3], new BoxStatus(firstPutOption.InstrumentToken, avgPrice[3], 40));

                ////OrderedBox.Add(firstCallOrder["data"]["order_id"], new BoxStatus(firstCallOption.InstrumentToken, Global.kite.GetOrderHistory(firstCallOrder["data"]["order_id"]).AveragePrice, 40));
                ////OrderedBox.Add(secondCallOrder["data"]["order_id"], new BoxStatus(secondCallOption.InstrumentToken, Global.kite.GetOrderHistory(secondCallOrder["data"]["order_id"]).AveragePrice, 40));
                ////OrderedBox.Add(secondPutOrder["data"]["order_id"], new BoxStatus(secondPutOption.InstrumentToken, Global.kite.GetOrderHistory(secondPutOrder["data"]["order_id"]).AveragePrice, 40));
                ////OrderedBox.Add(firstPutOrder["data"]["order_id"], new BoxStatus(firstPutOption.InstrumentToken, Global.kite.GetOrderHistory(firstPutOrder["data"]["order_id"]).AveragePrice, 40));
                ...
                //Logger.LogWrite(String.Format("BOX:{0} : {1} & {2}", boxValue, firstCallOption.Strike, secondCallOption.Strike));

                //Global.UpdatePandL(boxValue);
                //boxValue = 0;


                //Logger.LogWrite(String.Format("{0};{1};{2};{3}", firstCallOption.Offers[1].Price, secondCallOption.Bids[1].Price, secondPutOption.Offers[1].Price, firstPutOption.Bids[1].Price));
                //Logger.LogWrite(String.Format("{0};{1};{2};{3}", firstCallOption.Bids[1].Price, secondCallOption.Offers[1].Price, secondPutOption.Bids[1].Price, firstPutOption.Offers[1].Price));
                //Logger.LogWrite(String.Format("{0};{1};{2};{3};{4};{5};{6};{7}", -avgPrice[0], avgPrice[1], -avgPrice[2], +avgPrice[3], +avgPrice[4], -avgPrice[5], +avgPrice[6], -avgPrice[7]));
                //Global.StopTicker();
        ...
        private static void SelectInstruments()
        {
        ...
        private static void MonitorBox(Dictionary<UInt32, Instrument> CurrentBox)
        {
            ...
            if (premuimOppty > (currentBoxValue + 5m))
            {
                ...
                ///// GET QUOTE HERE BEFORE PLACING THE ORDER SO THAT YOU CAN SEE THAT THESE ORDERS ARE NOT AT VERY WRONG PRICE.PUT A BRACKET OF 5.
                orderStatus[0] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 40, firstCallOption.Bids[1].Price - 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                orderStatus[1] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 40, secondCallOption.Offers[1].Price + 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                orderStatus[2] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 40, secondPutOption.Bids[1].Price - 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                orderStatus[3] = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 40, firstPutOption.Offers[1].Price + 0.1m, Constants.PRODUCT_MIS, Constants.ORDER_TYPE_MARKET, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                ...
                //// Two keys: Status & Data, order_id
                //OrderedBox = new Dictionary<string, BoxStatus>();
                //OrderedBox.Add(firstCallOrder["data"]["order_id"], new BoxStatus(firstCallOption.InstrumentToken, 0, 40));
                //OrderedBox.Add(secondCallOrder["data"]["order_id"], new BoxStatus(secondCallOption.InstrumentToken, 0, 40));
                //OrderedBox.Add(secondPutOrder["data"]["order_id"], new BoxStatus(secondPutOption.InstrumentToken, 0, 40));
                //OrderedBox.Add(firstPutOrder["data"]["order_id"], new BoxStatus(firstPutOption.InstrumentToken, 0, 40));
