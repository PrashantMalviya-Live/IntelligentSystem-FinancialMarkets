...
namespace Algorithms.Algorithms
{
    public class AlertGenerator : IZMQ, IObserver<Tick>//, IKConsumer
    {
        ...
        private List<uint> _instrumentTokens;


        public AlertGenerator(AlertTriggerData alertTriggerData)
        {
            _indicators = alertTriggerData.Indicators;
            _timeSpans = alertTriggerData.TimeFramesinMinutes;
            SubscriptionTokens = alertTriggerData.InstrumentTokens;
        }
