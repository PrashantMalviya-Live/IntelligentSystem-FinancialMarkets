...
namespace AdvanceAlgos.Algorithms
{
    class BOX
    {
        ...
        private static void BoxSpread()
        {
            ...
            if (boxValue > 10 && firstCallOption.LastPrice * firstPutOption.LastPrice * secondPutOption.LastPrice * secondCallOption.LastPrice != 0)
            {
                ...
                Dictionary<string, dynamic> firstCallOrder = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 75, firstCallOption.LastPrice + 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                Dictionary<string, dynamic> secondCallOrder= Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 75, secondCallOption.LastPrice - 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                Dictionary<string, dynamic> secondPutOrder= Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 75, secondPutOption.LastPrice + 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                Dictionary<string, dynamic> firstPutOrder = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 75, firstPutOption.LastPrice - 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
               ...
               //// Two keys: Status & Data, order_id
                OrderedBox.Add(firstCallOrder["data"]["order_id"], new BoxStatus(firstCallOption.InstrumentToken,0,75));
                OrderedBox.Add(secondCallOrder["data"]["order_id"], new BoxStatus(secondCallOption.InstrumentToken, 0, 75));
                OrderedBox.Add(secondPutOrder["data"]["order_id"], new BoxStatus(secondPutOption.InstrumentToken, 0, 75));
                OrderedBox.Add(firstPutOrder["data"]["order_id"], new BoxStatus(firstPutOption.InstrumentToken, 0, 75));



                //OrderedBox.Add(secondCallOrder["data"]["order_id"], new BoxStatus(new Dictionary<string, dynamic>() { { "order_id", secondCallOrder["data"]["order_id"] }, { "average_price", 0 }, { "pending_quantity", 75 } }));
                //OrderedBox.Add(secondPutOrder["data"]["order_id"], new BoxStatus(new Dictionary<string, dynamic>() { { "order_id", secondPutOrder["data"]["order_id"] }, { "average_price", 0 }, { "pending_quantity", 75 } }));
                //OrderedBox.Add(firstPutOrder["data"]["order_id"], new BoxStatus(new Dictionary<string, dynamic>() { { "order_id", firstPutOrder["data"]["order_id"] }, { "average_price", 0 }, { "pending_quantity", 75 } }));
        ...
        private static void SelectInstrumentDataForSubscription()
        {
            ...
            foreach (KeyValuePair<string, LTP> optionLTP in OptionsLTP)
            {
                ...
                else if (BoxOptions.TryGetValue(optionLTP.Value.InstrumentToken, out boxOption))
                {
                    ...
                    if (Math.Abs(currentPrice - boxOption.Strike) > 300 || boxOption.Strike % 100 != 0)
                    {
        ...
        private static void MonitorBox(Tick TickData)
        {
            ...
            {
                ///// GET QUOTE HERE BEFORE PLACING THE ORDER SO THAT YOU CAN SEE THAT THESE ORDERS ARE NOT AT VERY WRONG PRICE.PUT A BRACKET OF 5.
                Dictionary<string, dynamic> firstCallOrder = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 75, firstCallOption.LastPrice - 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                Dictionary<string, dynamic> secondCallOrder = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondCallOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 75, secondCallOption.LastPrice + 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                Dictionary<string, dynamic> secondPutOrder = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, secondPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_SELL, 75, secondPutOption.LastPrice - 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
                Dictionary<string, dynamic> firstPutOrder = Global.kite.PlaceOrder(Constants.EXCHANGE_NFO, firstPutOption.TradingSymbol, Constants.TRANSACTION_TYPE_BUY, 75, firstPutOption.LastPrice + 0.5m, Constants.PRODUCT_NRML, Constants.ORDER_TYPE_LIMIT, Constants.VALIDITY_DAY, 1, null, null, null, null, Constants.VARIETY_REGULAR, "");
