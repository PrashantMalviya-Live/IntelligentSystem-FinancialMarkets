...
{
    public class MultipleEMAPriceAction : IZMQ, IObserver<Tick>//, IKConsumer
    {
        private int _algoInstance;
        private IDisposable unsubscriber;
        [field: NonSerialized]
        public delegate void OnOptionUniverseChangeHandler(MultipleEMAPriceAction source);
        [field: NonSerialized]
        ...
        public const AlgoIndex algoIndex = AlgoIndex.MultipleEMAPriceAction;
        ...
        //{
        //    DataLogic dl = new DataLogic();
        //    DataSet dsPAInputs = dl.LoadAlgoInputs(AlgoIndex.MultipleEMAPriceAction, Convert.ToDateTime("2021-11-30"), Convert.ToDateTime("2021-12-30"));
