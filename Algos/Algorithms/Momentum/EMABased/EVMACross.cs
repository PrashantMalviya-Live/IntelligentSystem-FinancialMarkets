...
namespace Algorithms.Algorithms.Momentum
{
    class EVMACross : IZMQ //, IObserver<Tick[]>
    {
        TimeSpan timeFrame;
        ...
        [field: NonSerialized]
        public delegate void OnOptionUniverseChangeHandler(EVMACross source);
        ...
        public EVMACross(uint instrumentToken, TimeSpan candleTimeSpan, int fEma, int sEMA)
        {
