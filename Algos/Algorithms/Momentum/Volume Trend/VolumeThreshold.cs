...
{
    public class VolumeThreshold : IZMQ
    {
        ...
        public VolumeThreshold(DateTime startTime,
        ...
        private void MonitorVolumeThreshold(List<Candle> timeCandles)
        {
            ...
            {
                if (t.ClosePrice > tokenLastClose[token] * (1 + PRICE_PERCENT_INCREASE) && t.TotalVolume > tokenVolume[token] * (1 + VOLUME_PERCENT_INCREASE))
                {
