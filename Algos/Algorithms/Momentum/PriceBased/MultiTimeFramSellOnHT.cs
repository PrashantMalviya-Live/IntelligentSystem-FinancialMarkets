        ...
        private void CandleManger_TimeCandleFinished(object sender, Candle e)
        {
            ...
            try
            {
                if (e.InstrumentToken == _baseInstrumentToken)
                {
                    ...
                    if (((h5tred == 0 && h3tred == 0 && h1tred == 1) && !_triggers.T1) /*|| (h15tred == 0 && h5tred == 1 && h3tred == 0) && !_triggers.T2*/)
                    {
                        _triggers.T1 = (h5tred == 0 && h3tred == 0 && h1tred == 1);
                    ...
                    else if (((h5tred == 1 && h3tred == 1 && h1tred == 0) && !_triggers.T3) /*|| ((h15tred == 1 && h5tred == 0 && h3tred == 1) && !_triggers.T4)*/)
                    {
                        //_triggers = new Triggers(h1tred, h3tred, h5tred, h15tred);
                        _triggers.T3 = (h5tred == 1 && h3tred == 1 && h1tred == 0);
