...
namespace Algorithms.Algorithms
{
    public class OptionSellonHT : IZMQ, IObserver<Tick>//, IKConsumer
    {
        ...
        private readonly int STOP_LOSS_POINTS = 20;//30; //40 points max loss on an average 
        private readonly int STOP_LOSS_POINTS_GAMMA = 20;//30;
