...
namespace Algorithms.Algorithms
{
    public class OptionSellonHT : IZMQ, IObserver<Tick>//, IKConsumer
    {
        ...
        private readonly int STOP_LOSS_POINTS = 50;//30; //40 points max loss on an average 
        private readonly int STOP_LOSS_POINTS_GAMMA = 50;//30;
        ...
        // 1 min: 30,50,70
        //25% quantity booked in each target
        private decimal FIRST_TARGET = 10;
        bool _firstPETargetActive = true;
        bool _firstCETargetActive = true;
        decimal _firstTargetQty = 0.1m;

        private decimal SECOND_TARGET = 20;
        bool _secondPETargetActive = true;
        bool _secondCETargetActive = true;
        decimal _secondTargetQty = 0.1m;

        private decimal THIRD_TARGET = 30;
        bool _thirdPETargetActive = true;
        bool _thirdCETargetActive = true;
        decimal _thirdTargetQty = 0.1m;

        bool _fouthPETargetActive = true;
        bool _fifthPETargetActive = true;
        bool _sixthPETargetActive = true;
        bool _seventhPETargetActive = true;
        bool _eighthPETargetActive = true;
        bool _ninthPETargetActive = true;
        bool _tenthPETargetActive = true;

        bool _fouthCETargetActive = true;
        bool _fifthCETargetActive = true;
        bool _sixthCETargetActive = true;
        bool _seventhCETargetActive = true;
        bool _eighthCETargetActive = true;
        bool _ninthCETargetActive = true;
        bool _tenthCETargetActive = true;

        private decimal FOURTH_TARGET = 40;
        decimal _nextTargetQty = 0.1m;
        private decimal FIFTH_TARGET = 50;
        private decimal SIXTH_TARGET = 60;
        private decimal SEVENTH_TARGET = 70;
        private decimal EIGHTH_TARGET = 80;
        private decimal NINTH_TARGET = 90;
        private decimal TENTH_TARGET = 100;
        private decimal REENTRY_BUFFER = 10;
        

        private const decimal PNL_SL_TRAIL_LIMIT = 15000;
        private const decimal SL_TRAIL_LIMIT = 30;
                    ...
                    lock (tradeLock)
                    {
                        ...
                        if (SubscriptionTokens.Contains(token))
                        {
                            ...
                            if (OptionUniverse != null)
                            {
                               ...
                               && BookStopLoss(_putorderTrios, htrend == 0, ref _peCurrentProfit)
                               )
                                    {
                               ...
                               && BookStopLoss(_callorderTrios, htrend == 1, ref _ceCurrentProfit)
                               )
                                    {
                                ...
                                else
                                {
                                    ...
                                    /*ref _preFirstPETargetActive,*/ ref _firstPETargetActive, ref _secondPETargetActive, 
                                    ref _thirdPETargetActive, ref _fouthPETargetActive, ref _fifthPETargetActive, ref _sixthPETargetActive,
                                    ref _seventhPETargetActive, ref _eighthPETargetActive, ref _ninthPETargetActive, ref _tenthPETargetActive,
                                    ref _peCurrentProfit);
                                    _callProfitBookedQty += BookPartialProfit(_callorderTrios, tick, htrend == 0,
                                        /*ref _preFirstCETargetActive,*/ ref _firstCETargetActive, ref _secondCETargetActive,
                                        ref _thirdCETargetActive, ref _fouthCETargetActive, ref _fifthCETargetActive, ref _sixthCETargetActive,
                                    ref _seventhCETargetActive, ref _eighthCETargetActive, ref _ninthCETargetActive, ref _tenthCETargetActive,
                                        ref _ceCurrentProfit);


                                    //MakeReentry(_putorderTrios, tick, htrend == 0, ref _firstPETargetActive, ref _secondPETargetActive,
                                    //ref _thirdPETargetActive, ref _fouthPETargetActive, ref _fifthPETargetActive, ref _sixthPETargetActive,
                                    //ref _seventhPETargetActive, ref _eighthPETargetActive, ref _ninthPETargetActive, ref _tenthPETargetActive,
                                    //ref _peCurrentProfit);

                                    //MakeReentry(_callorderTrios, tick, htrend == 1, ref _firstCETargetActive, ref _secondCETargetActive,
                                    //ref _thirdCETargetActive, ref _fouthCETargetActive, ref _fifthCETargetActive, ref _sixthCETargetActive,
                                    //ref _seventhCETargetActive, ref _eighthCETargetActive, ref _ninthCETargetActive, ref _tenthCETargetActive,
                                    //    ref _ceCurrentProfit);
                                }
                        ...
                        TrailStopLoss(_putorderTrios, ref _peCurrentProfit);
                        TrailStopLoss(_callorderTrios, ref _ceCurrentProfit);
                        //if (TrailStopLoss(_putorderTrios, ref _peCurrentProfit))
                        //{
                        //    _peSLHit = true;
                        //};
                        //if(TrailStopLoss(_callorderTrios, ref _ceCurrentProfit))
                        //{
                        //    _ceSLHit = true;
                        //}
                        //TrailPNLStopLoss(currentTime);
                    }
                }
            ...
            try
            {
                if (e.InstrumentToken == _baseInstrumentToken)
                {
                    ...
                    if (_stockTokenHalfTrend.ContainsKey(_bCandle.InstrumentToken))
                    {
                        ...
                        if (suspensionWindow && previoushtred == 1 && htred == 0)
                        {
                            _callTrigerred = false;
                            _putTriggered = true;
                            ...
                            _fouthPETargetActive = true;
                            _fifthPETargetActive = true;
                            _sixthPETargetActive = true;
                            _seventhPETargetActive = true;
                            _eighthPETargetActive = true;
                            _ninthPETargetActive = true;
                            _tenthPETargetActive = true;
                            ...
                            else
                            {
                                ...
                                if (option.Strike != atmStrike && newQty > 0)
                                {
                                    ...
                                    orderTrio.Option = _atmOption;
                                    orderTrio.BaseInstrumentStopLoss = _downtrendlowswingindexvalue;
                                ...
                                else
                                {
                                    ...
                                    if (shouldbeQty > totalTradedQty)
                                    {
                                        ...
                                        orderTrio.Option = option;
                                        orderTrio.BaseInstrumentStopLoss = _putorderTrios[0].BaseInstrumentStopLoss;
                                        _initialStopLoss = orderTrio.BaseInstrumentStopLoss;
                                        orderTrio.EntryTradeTime = orderTrio.Order.OrderTimestamp.Value;
                                        //first target is 1:1 R&R
                                        orderTrio.TargetProfit = 2 * orderTrio.Order.AveragePrice - _downtrendlowswingindexvalue;
                                        _lastOrderTransactionType = "sell";
                        ...
                        else if (suspensionWindow && previoushtred == 0 && htred == 1)
                        {
                            _putTriggered = false;
                            _callTrigerred = true;
                            ...
                            _fouthCETargetActive = true;
                            _fifthCETargetActive = true;
                            _sixthCETargetActive = true;
                            _seventhCETargetActive = true;
                            _eighthCETargetActive = true;
                            _ninthCETargetActive = true;
                            _tenthCETargetActive = true;
                            ...
                            else
                            {
                                ...
                                if (option.Strike != atmStrike && newQty > 0)
                                {
                                    ...
                                    orderTrio.Option = _atmOption;
                                    orderTrio.BaseInstrumentStopLoss = _uptrendhighswingindexvalue;
                                ...
                                else
                                {
                                    ...
                                    if (shouldbeQty > totalTradedQty)
                                    {
                                        ...
                                        orderTrio.Option = option;
                                        orderTrio.BaseInstrumentStopLoss = _callorderTrios[0].BaseInstrumentStopLoss;
                                        _initialStopLoss = orderTrio.BaseInstrumentStopLoss;
                                        orderTrio.EntryTradeTime = orderTrio.Order.OrderTimestamp.Value;
                                        orderTrio.isActive = true;
                                        //first target is 1:1 R&R
                        ...
                        if (_callorderTrios.Count != 0)
                        {
                            for (int i = 0; i < _callorderTrios.Count; i++)
                            {
                                ...
                                if (orderTrio.Order.TransactionType.ToLower().Trim() == "sell" && _baseInstrumentPrice > orderTrio.BaseInstrumentStopLoss && htred == 0)
                                {
                                    Instrument option = orderTrio.Option;
                        ...
                        if (_putorderTrios.Count != 0)
                        {
                            for (int i = 0; i < _putorderTrios.Count; i++)
                            {
                                ...
                                if (orderTrio.Order.TransactionType.ToLower().Trim() == "sell" && _baseInstrumentPrice < orderTrio.BaseInstrumentStopLoss && htred == 1)
                                {
                                    Instrument option = orderTrio.Option;
        ...
        private void ExecuteTrade(Tick tick, DateTime currentTime)
        {
                ...
                )
            {
                ...
                {
                    decimal stopLoss = 0;
                    if (_putTriggered && _putorderTrios.Count == 0 && (htvalue >= _baseInstrumentPrice - (_candleTimeSpan.Minutes == 5? 31: 11) ))
                    {
                    ...
                    else if (_putTriggered && _putorderTrios.Count != 0 && (_baseInstrumentPrice - _putorderTrios[0].BaseInstrumentStopLoss < 300))
                    {
                        // TODO: COMMENTED FOR NOT INCREASING QTY LATER
                        stopLoss = _putorderTrios[0].BaseInstrumentStopLoss;
                ...
                else if (htred == 1 && (!_ceSLHit || (_ceSLHit &&  htvalue < _previousDownswingValue)))// && _callTrigerred)
                {
                    decimal stopLoss = 0;
                    if (_callorderTrios.Count == 0 && _callTrigerred && (htvalue <= _baseInstrumentPrice + (_candleTimeSpan.Minutes == 5 ? 31 : 11)))
                    {
                        //LastSwingHighlow(currentTime, _baseInstrumentToken, out _swingHighPrice, out _swingLowPrice);
                        _firstCETargetActive = true;
                        _secondCETargetActive = true;
                    ...
                    else if (_callTrigerred && _callorderTrios.Count != 0 && (_callorderTrios[0].BaseInstrumentStopLoss - _baseInstrumentPrice < 300))
                    {
                        //TODO: COMMENTED FOR NOT INCREASING QTY LATER
                        stopLoss = _callorderTrios[0].BaseInstrumentStopLoss;
        ...
        private bool TrailStopLoss(List<OrderTrio> orderTrios, ref decimal tradeCurrentProfit)
        {
            bool slHit = false;
            if (orderTrios.Count > 0)
            {
                ...
                if (currentProfit - tradeCurrentProfit > SL_TRAIL_LIMIT * 2)
                {
        ...
        //Make Reentry at 20 points profit for each level
        private void MakeReentry(List<OrderTrio> orderTrios, Tick tick, bool trendChanged,
            ref bool firstTradeActive, ref bool secondTradeActive, ref bool thirdTradeActive,
            ref bool fourthTradeActive, ref bool fifthTradeActive, ref bool sixthTradeActive,
            ref bool seventhTradeActive, ref bool eightTradeActive, ref bool ninthTradeActive,
            ref bool tenthTradeActive,
            ref decimal tradeCurrentProfit)
        {
            int totalTradedQty = orderTrios.Sum(x => x.Order.Quantity);
            ...
            if (totalTradedQty < totalQty)
            {
                for (int i = 0; i < orderTrios.Count; i++)
                {
                    ...
                    {
                        if ((tick.LastPrice > orderTrio.Order.AveragePrice - NINTH_TARGET + REENTRY_BUFFER)
                            && !ninthTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 6 * _nextTargetQty) * totalQty

                            )
                        {
                            ninthTradeActive = true;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - EIGHTH_TARGET + REENTRY_BUFFER)
                            && !eightTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 5 * _nextTargetQty) * totalQty

                            )
                        {
                            eightTradeActive = true;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - SEVENTH_TARGET + REENTRY_BUFFER)
                            && !seventhTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 4 * _nextTargetQty) * totalQty

                            )
                        {
                            seventhTradeActive = true;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - SIXTH_TARGET + REENTRY_BUFFER)
                            && !sixthTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 3 * _nextTargetQty) * totalQty
                            )
                        {
                            sixthTradeActive = true;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - FIFTH_TARGET + REENTRY_BUFFER)
                            && !fifthTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 2* _nextTargetQty) * totalQty
                            )
                        {
                            fifthTradeActive = true;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - FOURTH_TARGET + REENTRY_BUFFER)
                            && !fourthTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + _nextTargetQty) * totalQty
                            )
                        {
                            fourthTradeActive = true;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - THIRD_TARGET + REENTRY_BUFFER)
                            && !thirdTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty) * totalQty
                            )
                        {
                            thirdTradeActive = true;
                            qty = Convert.ToInt32(_thirdTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - SECOND_TARGET + REENTRY_BUFFER)
                            && !secondTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty) * totalQty
                            )
                        {
                            secondTradeActive = true;
                            qty = Convert.ToInt32(_secondTargetQty * totalQty);
                        }
                        else if ((tick.LastPrice > orderTrio.Order.AveragePrice - FIRST_TARGET + REENTRY_BUFFER)
                            && !firstTradeActive
                            && orderTrio.isActive
                            && totalTradedQty > totalQty - _firstTargetQty * totalQty
                            )
                        {
                        ...
                        qty -= qty % 25;
                        if (qty > 0 && totalTradedQty + qty <= totalQty)
                        {
                            qty -= qty % 25;
                            Instrument option = orderTrio.Option;
                            ...
                            quantityTraded = qty;
                            Order order = MarketOrders.PlaceOrder(_algoInstance, option.TradingSymbol, option.InstrumentType.ToLower(), option.LastPrice,
                               option.KToken, false, qty, algoIndex, _bCandle.CloseTime, Tag: "",
                               product: _intraday ? Constants.PRODUCT_MIS : Constants.KPRODUCT_NRML,
                               broker: Constants.KOTAK,
                               httpClient: _httpClientFactory == null ? null : KoConnect.ConfigureHttpClient(_user, _httpClientFactory.CreateClient()), user: _user);
                            ...
                            OrderTrio newOrderTrio = new OrderTrio();
                            newOrderTrio.Order = order;
                            newOrderTrio.Option = option;
                            newOrderTrio.isActive = false;
                            newOrderTrio.EntryTradeTime = order.OrderTimestamp.Value;
                            newOrderTrio.BaseInstrumentStopLoss = orderTrio.BaseInstrumentStopLoss;
                            newOrderTrio.TargetProfit = 2 * newOrderTrio.Order.AveragePrice - newOrderTrio.BaseInstrumentStopLoss;
                            DataLogic dl = new DataLogic();
                            newOrderTrio.Id = dl.UpdateOrderTrio(newOrderTrio, _algoInstance);
                            dl.UpdateAlgoPnl(_algoInstance, _pnl);

                            totalTradedQty = orderTrios.Sum(x => x.Order.Quantity);

                            orderTrios.Add(newOrderTrio);
                            break;
                        }
                    }
                }
        ...
        private int BookPartialProfit(List<OrderTrio> orderTrios, Tick tick, bool trendChanged,
            ref bool firstTradeActive, ref bool secondTradeActive, ref bool thirdTradeActive,
            ref bool fourthTradeActive, ref bool fifthTradeActive, ref bool sixthTradeActive,
            ref bool seventhTradeActive, ref bool eightTradeActive, ref bool ninthTradeActive,
            ref bool tenthTradeActive, 
                ...
                if (orderTrio.Option.InstrumentToken == tick.InstrumentToken)
                {
                    if (orderTrio.Order.TransactionType.ToLower().Trim() == "sell")
                    {
                        ...
                        //&& totalTradedQty > (_tradeQty * Convert.ToInt32(_lotSize) * 2 / 4)
                         && totalTradedQty > totalQty - _firstTargetQty * totalQty + _firstTargetQty * totalQty %25
                        && firstTradeActive)
                        {
                        ...
                        && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty) * totalQty + (_firstTargetQty + _secondTargetQty) * totalQty %25
                        && secondTradeActive)
                        {
                        ...
                        //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                        && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty) * totalQty + (_firstTargetQty + _secondTargetQty + _thirdTargetQty) * totalQty %25
                        && thirdTradeActive)
                        {
                            thirdTradeActive = false;
                            qty = Convert.ToInt32(_thirdTargetQty * totalQty);
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + FOURTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty +_nextTargetQty) * totalQty 
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + _nextTargetQty) * totalQty %25
                       && fourthTradeActive)
                        {
                            fourthTradeActive = false;
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + FIFTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 2*_nextTargetQty) * totalQty
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 2 * _nextTargetQty) * totalQty %25

                       && fifthTradeActive)
                        {
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                            fifthTradeActive = false;
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + SIXTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 3 * _nextTargetQty) * totalQty
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 3 * _nextTargetQty) * totalQty %25

                       && sixthTradeActive)
                        {
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                            sixthTradeActive = false;
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + SEVENTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 4 * _nextTargetQty) * totalQty
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 4 * _nextTargetQty) * totalQty %25
                       && seventhTradeActive)
                        {
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                            seventhTradeActive = false;
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + EIGHTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 5 * _nextTargetQty) * totalQty
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 5 * _nextTargetQty) * totalQty %25
                       && eightTradeActive)
                        {
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                            eightTradeActive = false;
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + NINTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 6 * _nextTargetQty) * totalQty
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 6 * _nextTargetQty) * totalQty %25
                       && ninthTradeActive)
                        {
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                            ninthTradeActive = false;
                        }
                        else if ((orderTrio.Order.AveragePrice > tick.LastPrice + TENTH_TARGET)
                       //&& totalTradedQty >= (_tradeQty * Convert.ToInt32(_lotSize) * 1 / 4)
                       && totalTradedQty > totalQty - (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 7 * _nextTargetQty) * totalQty
                       + (_firstTargetQty + _secondTargetQty + _thirdTargetQty + 7 * _nextTargetQty) * totalQty %25
                       && tenthTradeActive)
                        {
                            qty = Convert.ToInt32(_nextTargetQty * totalQty);
                            tenthTradeActive = false;
                        }
