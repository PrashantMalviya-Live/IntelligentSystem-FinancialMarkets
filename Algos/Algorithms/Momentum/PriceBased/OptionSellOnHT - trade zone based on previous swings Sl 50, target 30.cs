...
namespace Algorithms.Algorithms
{
    public class OptionSellonHT : IZMQ, IObserver<Tick>//, IKConsumer
    {
        ...
        private readonly int STOP_LOSS_POINTS = 30;//30; //40 points max loss on an average 
        private readonly int STOP_LOSS_POINTS_GAMMA = 30;//30;
        ...
        private const decimal SL_TRAIL_LIMIT = 50;
