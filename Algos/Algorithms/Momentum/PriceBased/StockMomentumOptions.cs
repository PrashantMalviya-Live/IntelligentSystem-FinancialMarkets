...
{
    public class StockMomentumOptions : IZMQ, IObserver<Tick>//, IKConsumer
    {
        private int _algoInstance;
        private IDisposable unsubscriber;
        [field: NonSerialized]
        public delegate void OnOptionUniverseChangeHandler(StockMomentumOptions source);
        [field: NonSerialized]
        ...
        public StockMomentumOptions(TimeSpan candleTimeSpan, uint baseInstrumentToken,
        ...
        private void CandleManger_TimeCandleFinished(object sender, Candle e)
        {
            try
            {
                ...
                //}
                if (e.CloseTime.TimeOfDay <= new TimeSpan(09, 34, 00))
                {
