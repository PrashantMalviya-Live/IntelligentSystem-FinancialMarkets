    ...
    public class RangeBreakoutCandle : IZMQ, IObserver<Tick>//, IKConsumer
    {
        ...
        public void LoadActiveOrders(PriceActionInput paInput)
        {
            ...
            if (activeOrderTrios != null)
            {
                ...
                _previousPriceRange = paInput.PPR;
        ...
        private void ExecuteTrade(Tick tick, DateTime currentTime)
        {
            ...
            if (_currentBreakOutMode == Breakout.UP)
            {
                ...
                decimal targetProfit = 2 * _previousPriceRange.Upper - _previousPriceRange.Lower;
                decimal sl = _currentPriceRange.NextLower;
            ...
            {
                //check if future has already reached the target;
                decimal targetProfit = 2 * _previousPriceRange.Lower - _previousPriceRange.Upper;
                decimal sl = _currentPriceRange.NextUpper;
            ...
            if (_putTriggered)
            {
                ...
                orderTrio.BaseInstrumentStopLoss = _currentPriceRange.NextLower;
            ...
            else if(_callTrigered)
            {
                ...
                //SL SHIFTED TO HIGH OF PREVIOUS CANDLE
                //orderTrio.BaseInstrumentStopLoss = stopLoss;
                orderTrio.BaseInstrumentStopLoss = _currentPriceRange.NextUpper;
                orderTrio.EntryTradeTime = currentTime;
        ...
        private Breakout UpdatePriceRange(Candle tc, int currentCandleIndex, uint instrumentToken)
        {
            ...
            else if (tc.ClosePrice > _currentPriceRange.NextUpper)
            {
                ...
                DataLogic dl = new DataLogic();
                dl.UpdateAlgoParamaters(_algoInstance, arg1: Convert.ToInt32(breakout), upperLimit:  _currentPriceRange.Upper, lowerLimit: _currentPriceRange.Lower, 
                    arg2: _currentPriceRange.NextUpper, arg3: _currentPriceRange.NextLower, arg4: _previousPriceRange.Upper, arg5: _previousPriceRange.Lower,
                    arg6: _previousPriceRange.NextUpper, arg7: _currentPriceRange.NextLower);
            }
            ...
            else if (tc.ClosePrice < _currentPriceRange.NextLower)
            {
                CopyPriceRange(_currentPriceRange, _previousPriceRange);
                _currentPriceRange.Lower = tc.LowPrice;
                _currentPriceRange.NextLower = tc.LowPrice;
