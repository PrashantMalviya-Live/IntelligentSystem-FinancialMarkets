...
{
    public class OptionSellonEMACross : IZMQ, IObserver<Tick>//, IKConsumer
    {
        private int _algoInstance;
        private IDisposable unsubscriber;
        [field: NonSerialized]
        public delegate void OnOptionUniverseChangeHandler(OptionSellonEMACross source);
        [field: NonSerialized]
        ...
        public OptionSellonEMACross(TimeSpan candleTimeSpan, uint baseInstrumentToken,
        ...
        /// <summary>
        /// Trade on EMA and price cross for larger time frame., with swing as SL
        /// </summary>
