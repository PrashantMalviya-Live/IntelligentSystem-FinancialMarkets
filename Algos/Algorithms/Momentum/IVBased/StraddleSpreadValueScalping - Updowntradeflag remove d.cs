...
namespace Algorithms.Algorithms
{
    public class StraddleSpreadValueScalping : IZMQ
    {
        ...
        private async Task CallEntryTrades(decimal optionStrike, decimal tradeStrike, decimal currentSellStraddleValue, DateTime currentTime, bool currentUpTrade)
        {
            await ExecuteOrderEntry(optionStrike, tradeStrike, currentSellStraddleValue, currentTime, currentUpTrade);
        }
        private async Task ExecuteOrderEntry(decimal optionStrike, decimal tradeStrike, decimal currentSellStraddleValue, DateTime currentTime, bool currentUpTrade)
        {
