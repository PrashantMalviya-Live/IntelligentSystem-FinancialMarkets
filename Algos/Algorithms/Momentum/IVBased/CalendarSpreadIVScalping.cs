...
{
    public class CalendarSpreadIVScalping : IZMQ
    {
        ...
        [field: NonSerialized]
        public delegate void OnOptionUniverseChangeHandler(CalendarSpreadIVScalping source);
        [field: NonSerialized]
        ...
        public CalendarSpreadIVScalping(DateTime endTime, uint baseInstrumentToken,
            DateTime? nearExpiry, DateTime? farExpiry, int quantity, decimal targetProfit, decimal stopLoss, 
