                    ...
                    if (tick.LastTradeTime.HasValue)
                    {
                       ...
                       && CurrentBuyStraddleValue[optionStrike][(int)InstrumentType.PE] != 0)
                       ...
                       )
                        {
                            ...
                            {
                                //(currentSellStraddleValue - HistoricalStraddleAverage[option.Strike].Value) >= _openSpread))
                            ...
                            )
                        {
                            ...
                            if (  (option.Strike <= _baseInstrumentPrice + _strikePriceRange && option.Strike >= _baseInstrumentPrice - _strikePriceRange)
                                ...
                                && ((currentSellStraddleValue - (TradedStraddleValue[tradeStrike].Last() + 10)) >= _openSpread)))
