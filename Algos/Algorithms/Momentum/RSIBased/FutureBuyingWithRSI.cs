...
{
    public class FutureBuyWithRSI : IZMQ
    {
        ...
        [field: NonSerialized]
        public delegate void OnOptionUniverseChangeHandler(FutureBuyWithRSI source);
        [field: NonSerialized]
        ...
        public FutureBuyWithRSI(DateTime endTime, TimeSpan candleTimeSpan, uint baseInstrumentToken, 
            ...
            try
            {
                ...
                lock (TimeCandles)
                {
                    ...
                    else if (tick.LastTradeTime.HasValue)
                    {
                        ...
                        {
                            TradeEntry(token, tick.LastPrice, currentTime, rsi, ema, _bEMAValue);

                            //if (_orderTrio == null)
                            //{
                            //    _orderTrio = TradeEntry(token, tick.LastPrice, currentTime, rsi, ema, _bEMAValue);
                            //}
                            //else
                            //{
                            //    bool orderExited = TradeExit(token, currentTime, tick.LastPrice, _orderTrio, rsi, ema);
